...
| `type`        | `'DEPOSIT' \| 'UNLOCK' \| 'INTEREST_CLAIM' \| 'MATCH'`   | Vault event kind. Mirrors Flask's `VaultTransaction` type enum.                                                                                                                                                                                                                                                                                                                       |
| `description` | `string`                                                  | Free-text reason (e.g. "weekly interest", "goal unlocked").                                                                                                                                                                                                                                                                                                                           |
